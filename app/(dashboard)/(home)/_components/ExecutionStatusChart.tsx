...
type ChartDate = Awaited<ReturnType<typeof getWorkflowExecutionsStats>>;
...
function ExecutionStatusChart({ data }: { data: ChartDate }) {
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Daily number of successfull and failed executed workflows
        </CardDescription>
      </CardHeader>
      <CardContent>
